...
public class KeyPairBuilderTest {
    ...
    public void testWithParamsDH(@ConvertWith(HexConverter.class) BigInteger p,
        ...
        assertAll(
            () -> assertEquals(p, ((DHKey) keyPair.getPrivate()).getParams().getP()),
            () -> assertEquals(g, ((DHKey) keyPair.getPrivate()).getParams().getG()),
            () -> assertEquals(p, ((DHKey) keyPair.getPublic()).getParams().getP()),
            () -> assertEquals(g, ((DHKey) keyPair.getPublic()).getParams().getG())
        );
    }
    ...
    public void testWithParamsDSA(
        ...
        assertAll(
            () -> assertEquals(p, ((DSAKey) keyPair.getPrivate()).getParams().getP()),
            () -> assertEquals(q, ((DSAKey) keyPair.getPrivate()).getParams().getQ()),
            () -> assertEquals(g, ((DSAKey) keyPair.getPrivate()).getParams().getG()),
            () -> assertEquals(p, ((DSAKey) keyPair.getPublic()).getParams().getP()),
            () -> assertEquals(q, ((DSAKey) keyPair.getPublic()).getParams().getQ()),
            () -> assertEquals(g, ((DSAKey) keyPair.getPublic()).getParams().getG())
        );
    }
